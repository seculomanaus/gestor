...
class Prova_questao_model extends CI_Model {
    ...
    function resultado_final($p) {
        ...
        // $this->db->close();
         ...
         return $this->db->query("select d.cd_prova, d.nr_acerto, d.nr_erro,           

           CASE  WHEN d.nr_nota>0 and d.nr_nota<1 then '0' || to_char(d.nr_nota)
                   when LENGTH(to_char(d.nr_nota)) = 1 then  to_char(d.nr_nota) || ',0' 
                   else to_char(d.nr_nota) 
                   end as nr_nota,         
