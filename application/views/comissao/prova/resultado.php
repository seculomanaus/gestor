    ...
    <body>
            ...
            <div class="col-sm-2 col-lg-offset-1">
                ...
                <div class="hpanel hyellow">
                    <div class="media social-profile clearfix">
                        <a class="pull-left">
                            <img width='150' src="https://www.seculomanaus.com.br/portal/restrito/foto?codigo=<?=$this->session->userdata('PVO_USER')?>" class="img-rounded">
                        </a>
                        ...
                        <span class="btn-group">
                            ...
                            <a href="<?=base_url('usuario/logout')?>" class="btn btn-danger2" style="font-size: 15px">
                ...
                <? foreach($lista as $l){ ?>
                    ...
                    <div class="row">
                        <div class="col-sm-4 text-center">
                            ...
                            <h5 class="blue">ACERTO<?=(($l['NR_ACERTO'] > 1)? 'S' : '')?></h5>
                        </div>
                        <div class="col-sm-4 text-center"> 
                            ...
                            <h5 class="blue">ERRO<?=(($l['NR_ERRO'] > 1)? 'S' : '')?></h5>
                        </div>
                        <div class="col-sm-4 text-center">
                            <div class="circle c3 img-circle">                                
                                <span class="price-large green">
                                    <?=number_format($l['NR_NOTA'],1,'.','')?></small>
                                </span>
                            </div>
        ...
        <script>
            $( document ).ready(function() {
                <? foreach($lista as $l){ ?>
                $("#acerto_<?=$l['CD_DISCIPLINA']?>").circliful({
                    text: 'ACERTO(s)',
                    animation: 1,
                    animationStep: 10,
                ...
                $("#erro_<?=$l['CD_DISCIPLINA']?>").circliful({
                    text: 'ERRO(s)',
                    animation: 1,
                    animationStep: 10,
                    foregroundBorderWidth: 5,
                ...
                $("#nota_<?=$l['CD_DISCIPLINA']?>").circliful({
                    animation: 1,
                    animationStep: 10,
                    text: 'NOTA',
                    foregroundBorderWidth: 5,
